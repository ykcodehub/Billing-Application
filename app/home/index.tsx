...
//       <AppHeader title="Store" subtitle="Hello," />

//       <DashboardCard
//         title="TODAY'S EARNINGS"
//         value="₹0"
//         subtitle="0 bills today"
//       />
...
//           onPress={() => router.push("/billing/normal")}
//         />

//         <IconMenuCard
//           title="Products"
//           color="#111"
//           icon={<Ionicons name="cube" size={26} color="#fff" />}
...
//           title="Reports"
//           color="#F5A623"
//           icon={<Ionicons name="bar-chart" size={26} color="#fff" />}
...
export default function HomeScreen() {
  ...
  const loadDashboard = () => {
    ...
    setRecentBills(BillService.getRecentBills(5) as any[]);
  };
